...
Related to r and wl is the refractive index. Typically this is dependent on the wavelength, although the exact form differs depending on the desired simulation. Examples illustrating common situations of interest are found in the Examples folder. 
...
In order to run this code, you must have Python 3 installed on your computer. Those new to Python are recommended to install Anaconda (https://www.anaconda.com/download) as this is, in the author's experience, the easiest way to get started with Python. Code was written in Python 3.11.5, but should run with any version of Python 3.
